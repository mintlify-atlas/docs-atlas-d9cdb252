...
description: "A reference for Developer Dossier's full color palette, three-font typography system, and custom Tailwind utility classes like glass-panel and ambient-glow."
---
...
```
border border-violet/30 bg-slate/80 shadow backdrop-blur-md
```
